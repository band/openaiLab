...
1. Input.txt [this file will take the input of big pdf that we will summarize]
2. output.txt [it's basically a dumb file so that the code will run smoothly.
3. prompt.txt [this file contains how we want to summarize our text: the prompt used for GPT output]
